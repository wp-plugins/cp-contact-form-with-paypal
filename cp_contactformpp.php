...
function _cp_contactformpp_install() {
    ...
    {                
        $wpdb->insert( $table_name, array( 'id' => 1,
                                      ...
                                      'request_cost' => cp_contactformpp_get_option('request_cost', CP_CONTACTFORMPP_DEFAULT_PRODUCT_NAME),
                                      'paypal_product_name' => cp_contactformpp_get_option('paypal_product_name', CP_CONTACTFORMPP_DEFAULT_COST),
